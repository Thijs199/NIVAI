#!/bin/bash
# setup-dev-env.sh - Script to set up development environment for AIFAA project
...
echo -e "${GREEN}Setting up AIFAA development environment...${NC}"
...
cat > "$ENV_FILE" << EOF
# AIFAA Environment Configuration
