  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center px-6 py-32 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Advanced football tracking data visualization and analysis platform. Gain tactical
            insights and performance metrics powered by cutting-edge technology.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-8">
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-800 text-white mb-5">
                  <Image src="/globe.svg" alt="Performance Analytics" width={24} height={24} />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Performance Analytics</h3>
                <p className="text-gray-600">
                  Track player movements, heatmaps, and physical metrics with precise data-driven
                  insights.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-8">
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-800 text-white mb-5">
                  <Image src="/window.svg" alt="Tactical Analysis" width={24} height={24} />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Tactical Analysis</h3>
                <p className="text-gray-600">
                  Visualize team formations, passing networks, and pressing patterns in real-time.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-8">
                <div className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-800 text-white mb-5">
                  <Image src="/file.svg" alt="Video Integration" width={24} height={24} />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Video Integration</h3>
                <p className="text-gray-600">
                  Synchronize video footage with tracking data for comprehensive match analysis.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Recent Matches</h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* This would be populated from an API call in a real application */}
            {['Ajax vs PSV', 'Feyenoord vs AZ', 'FC Utrecht vs FC Twente'].map((match, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-lg text-gray-800">{match}</h3>
                  <p className="text-gray-500 text-sm mt-1">Eredivisie • May 15, 2023</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-blue-800 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to elevate your football analysis?</h2>
