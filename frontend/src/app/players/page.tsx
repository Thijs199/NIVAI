                  ...
                  {playerData
                    ...
                    .map((player, idx) => (
                      <li key={player.id} className="flex items-center">
                        ...
                        <span className="font-semibold text-blue-600">{player.stats.rating.toFixed(1)}</span>
                      </li>
                    ))}
                </ol>
                <div className="mt-4 text-right">
                  ...
                  {playerData
                    ...
                    .map((player, idx) => (
                      <li key={player.id} className="flex items-center">
                        ...
                        <span className="font-semibold text-blue-600">{player.stats.topSpeed.toFixed(1)}</span>
                      </li>
                    ))}
                </ol>
                <div className="mt-4 text-right">
                  ...
                  {playerData.map((player) => {
                    ...
                    return (
                      <tr key={player.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${position.colorClass}`}>
                            {position.short}
                          </span>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex items-center justify-center">
                            <span className={`inline-flex items-center justify-center h-8 w-8 rounded-full text-sm font-medium ${
                              player.stats.rating >= 8 ? "bg-green-100 text-green-800" : 
                              player.stats.rating >= 7 ? "bg-blue-100 text-blue-800" : 
